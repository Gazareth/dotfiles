...
local assignment = require("configs.hydra.atlantis-deprecated.prepare.anchor_point.build.anchor_fill.nav_column.labels.label_strategies.assignment")
local fallback = require("configs.hydra.atlantis-deprecated.prepare.anchor_point.build.anchor_fill.nav_column.labels.label_strategies.fallback")
local fn_strategy = require("configs.hydra.atlantis-deprecated.prepare.anchor_point.build.anchor_fill.nav_column.labels.label_strategies.function")

...
local condense = require("configs.hydra.atlantis-deprecated.prepare.anchor_point.build.anchor_fill.nav_column.labels.condense")
local text = require("configs.hydra.atlantis-deprecated.prepare.anchor_point.build.anchor_fill.nav_column.labels.text")
local short_label = require("configs.hydra.atlantis-deprecated.prepare.anchor_point.probe.short_label")

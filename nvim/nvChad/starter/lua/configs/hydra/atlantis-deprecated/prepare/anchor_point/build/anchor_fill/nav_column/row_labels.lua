local labels = require("configs.hydra.atlantis-deprecated.prepare.anchor_point.build.anchor_fill.nav_column.labels")
...
local function emit_labeled_separator(items, label)
...
function M.append(items, group_id)
  ...
  emit_labeled_separator(items, label)
end

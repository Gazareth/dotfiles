...
local salvage_target = require("configs.hydra.atlantis-deprecated.prepare.anchor_point.build.anchor_fill.nav_column.salvage_target")
...
local function collect_siblings(container, bufnr, resolve_options)
  ...
  local function walk(n)
    for i = 0, n:named_child_count() - 1 do
      ...
      if ok and not (sem and sem.skip_in_siblings) then

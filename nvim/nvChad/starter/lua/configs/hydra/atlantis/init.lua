...
local container_build_spec = require("configs.hydra.atlantis.prepare.anchor_container.build_spec")
local container_scope_resolver = require("configs.hydra.atlantis.prepare.anchor_container.scope_resolver")

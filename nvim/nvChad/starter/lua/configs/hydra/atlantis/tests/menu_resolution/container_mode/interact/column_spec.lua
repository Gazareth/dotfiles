...
describe("[Atlantis menu] Interact column (container mode)", function()
  ...
  it("Function anchor lists Declarations in Interact when container includes parameters", function()
  ...
  it("top-level callable body lists actionable outline rows in Interact", function()
    local solo = {
      "local function solo()",
      "  local x = 1",
      "  return x",
  ...
  it("Assignment anchor surfaces Assignments in Interact", function()
  ...
  it("Boolean expression anchor surfaces Control flow / Keywords in Interact", function()

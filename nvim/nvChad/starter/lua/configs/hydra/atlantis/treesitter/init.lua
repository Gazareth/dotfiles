local parse_identifier = require("configs.hydra.atlantis.treesitter.probes.node_kinds.identifier").parse_identifier
local parse_assignment = require("configs.hydra.atlantis.treesitter.probes.node_kinds.assignment").parse_assignment
local parse_function = require("configs.hydra.atlantis.treesitter.probes.node_kinds.function").parse_function
local parse_parameter = require("configs.hydra.atlantis.treesitter.probes.node_kinds.parameter").parse_parameter
local parse_binary_expression = require("configs.hydra.atlantis.treesitter.probes.node_kinds.binary_expression").parse_binary_expression
local parse_generic = require("configs.hydra.atlantis.treesitter.probes.node_kinds.generic").parse_generic

local lib = require("configs.hydra.atlantis.treesitter.probes.node_kinds.function.lib")
local targets = require("configs.hydra.atlantis.treesitter.probes.node_kinds.function.lib.targets")
